...
export default class LandingPage extends Component {
    ...
    render() {
        return (
        <div>
            <header className="center px3 py4 white bg-no-repeat bg-cover bg-center" style="background-image: url(https://s3-us-west-2.amazonaws.com/gosuempire/assets/banner-gosu-empire.png);">
            ...
            <section className="container center p2" style="background-image: url(https://s3-us-west-2.amazonaws.com/gosuempire/assets/main_bg.png);">
